...
async def help_command(message: Message) -> None:
    ...
    await message.answer(
        ...
        "/preactdeep LINK|ID|dump — diagnóstico profundo com snapshots; também lê dump em .json/.txt por reply\n"
        "/preacttop — ranking dos posts com mais reações\n"
        "/preactfast — posts com maior delta recente\n"
        "/preactresumo — resumo geral por DM\n"
        "/preactcsv — exportar snapshots recentes em CSV textual\n"
        "/preactwatch LINK — observar manualmente um post específico\n"
        "/preactlist — listar posts observados\n"
        "/preactoff LINK — parar observação de um post\n\n"
